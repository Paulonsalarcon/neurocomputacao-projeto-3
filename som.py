...
class SOM(object):
    def __init__(self, x, y, input_dim, learning_rate, radius, num_iter=111):
        ...
        with self._graph.as_default():
            ...
            decay_function = tf.subtract(1.0, tf.math.divide(self._iter_input, self._num_iter))
            ...
            neighbourhood_func = tf.exp(tf.negative(tf.math.divide(tf.cast(bmu_distance, "float32"), tf.pow(_current_radius, 2))))
